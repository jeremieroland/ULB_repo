...
conjecture \cite{LS88}, which states that the communication
...
amortized communication complexity \cite{BW12},
...
Here is the general structure of our work plan (see also Figure XXX
below).
\begin{enumerate}
...
\begin{figure}
\begin{centering}
\includegraphics[width=0.8\paperwidth]{researchDiagram}
\par\end{centering}
...
was, however, one question, whose answer has become the subject of
his investigation; that of the paradoxical co-existence of contextuality
...
complete odds with this notion. After various attempts he was able
to show, that the notion of contextuality is in fact not necessary.
This was achieved by identifying another `classical property' and
constructing a non-contextual toy-model, serving as a counter-example
to the impossibility proof. The toy model has been generalised to
a discrete but arbitrarily sized Hilbert space, consistent with all
predictions of QM. Implications of violation of this `classical property'
were explored, in particular, to the notion of non-locality.

\begin{figure}
\begin{centering}
\includegraphics[bb=0bp 0bp 744bp 1052bp,width=0.5\paperwidth]{flow}
\par\end{centering}

\caption{Summary of progress flow. Bold faced titles represent new results.}
